...
`next-route-kit` communicates a toolkit rather than a replacement router or a full backend framework. The npm scope and four package names were confirmed during the 0.1.0 release and are now the published public identity of the project.
